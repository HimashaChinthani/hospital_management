...
func RegisterPaymentRoutes(r *gin.Engine, svc *service.PaymentService) {
	group := r.Group("/payments")
	{
		...
		group.GET("/:id", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToPaymentDTO(res)))
		})
		...
		group.GET("", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToPaymentDTOList(res)))
		})
		group.PUT("/:id", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToPaymentDTO(d)))
		})
