...
func RegisterDepartmentRoutes(r *gin.Engine, svc *service.DepartmentService) {
	group := r.Group("/departments")
	{
		...
		group.GET("/:id", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToDepartmentDTO(res)))
		})
		...
		group.GET("", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToDepartmentDTOList(res)))
		})
		group.PUT("/:id", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToDepartmentDTO(d)))
		})
