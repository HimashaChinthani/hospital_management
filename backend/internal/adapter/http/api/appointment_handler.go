...
func RegisterAppointmentRoutes(r *gin.Engine, svc *service.AppointmentService) {
	group := r.Group("/appointments")
	{
		...
		group.GET("/:id", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToAppointmentDTO(res)))
		})
		...
		group.GET("", func(c *gin.Context) {
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToAppointmentDTOList(res)))
		})
		group.PUT("/:id", func(c *gin.Context) {
			...
			if err != nil || existing == nil {
				c.JSON(http.StatusNotFound, common.ErrorResponse("appointment not found"))
				return
			}
			...
			c.JSON(http.StatusOK, common.Success(mapper.ToAppointmentDTO(existing)))
		})
